...
export default function LandingPage() {
      ...
      <nav className={`fixed top-4 md:top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl z-50 transition-all duration-500 rounded-2xl md:rounded-3xl border ${
        ...
        <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 md:w-8 md:h-8 bg-green-500 rounded-lg shadow-[0_0_15px_rgba(16,185,129,0.4)] flex items-center justify-center text-white">
              <i className="fas fa-book"></i>
            </div>
            <span className="text-lg md:text-xl font-bold tracking-tight dark:text-white">PinjamBuku.</span>
          </div>
  ...
  <a 
    href="/register" 
    className="px-4 py-2 md:px-6 md:py-2.5 border border-slate-900 dark:border-white text-slate-900 dark:text-white text-[10px] md:text-xs font-bold rounded-xl hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 transition-all"
  >
    Register
  </a>
  ...
  <a 
    href="/login" 
    className="px-4 py-2 md:px-6 md:py-2.5 bg-slate-900 dark:bg-white dark:text-slate-900 text-white text-[10px] md:text-xs font-bold rounded-xl shadow-lg transition-transform active:scale-95 hover:opacity-90"
  >
    Login
  </a>
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center pt-24 md:pt-0 px-4 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100/80 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 backdrop-blur-md mb-6 md:mb-8">
            ...
            <span className="text-[9px] md:text-[11px] font-bold uppercase tracking-widest text-slate-600 dark:text-slate-400">Library v2.0</span>
          </div>
          ...
          <h1 className="text-4xl sm:text-6xl md:text-[8rem] font-black tracking-tighter text-slate-900 dark:text-white leading-[1.1] md:leading-none mb-6">
            ...
            <span className="bg-gradient-to-r from-green-500 to-emerald-600 bg-clip-text text-transparent italic">Library.</span>
          </h1>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm md:text-xl max-w-[280px] sm:max-w-xl mx-auto mb-10 md:mb-12 font-medium leading-relaxed">
            Satu platform untuk manajemen peminjaman buku. Cepat, transparan, dan terintegrasi otomatis.
          </p>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
            ...
            <div className="md:col-span-8 bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 rounded-[2rem] md:rounded-[2.5rem] p-8 md:p-12 overflow-hidden">
              ...
              <h3 className="text-3xl md:text-4xl font-bold dark:text-white mb-4 tracking-tight">Real-time <br />Stock Info.</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base max-w-xs">Cek ketersediaan buku favoritmu kapan saja tanpa harus ke perpustakaan.</p>
            </div>
            ...
            <div className="md:col-span-4 h-64 md:h-auto bg-slate-900 rounded-[2rem] md:rounded-[2.5rem] relative overflow-hidden flex flex-col justify-end p-8 text-white">
              <img src="https://images.unsplash.com/photo-1507842217343-583bb7270b66?auto=format&fit=crop&q=80&w=600" className="absolute inset-0 w-full h-full object-cover opacity-40" alt="library" />
              <div className="relative z-10">
                <h3 className="text-xl font-bold mb-1">Easy Tracking</h3>
                <p className="text-slate-400 text-[10px] md:text-xs">Sistem pengembalian & denda otomatis.</p>
              </div>
            </div>
            ...
            <div className="md:col-span-12 bg-linear-to-r from-emerald-500 to-green-600 rounded-[2rem] md:rounded-[3rem] p-8 md:p-16 text-white text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8">
                <div>
                    <h3 className="text-3xl md:text-5xl font-bold mb-4 tracking-tighter">Ready to read?</h3>
                    <p className="text-green-100 text-sm md:text-lg opacity-80 mb-6 md:mb-0">Modernkan perpustakaan sekolahmu dalam satu klik.</p>
                </div>
      ...
      <footer className="py-12 md:py-20 border-t border-slate-100 dark:border-slate-900 px-6">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8 text-center md:text-left">
          <span className="text-slate-400 text-[9px] md:text-[11px] font-bold uppercase tracking-[0.2em]">© 2026 PINJAMBUKU SYSTEM</span>
